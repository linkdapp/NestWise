...
| `ssh_equivalence` | `rac_nodes` | Passwordless SSH for `grid`/`oracle` across both nodes (self included) — a genuine GI/OUI prerequisite, not just for `cluvfy`; see `docs/known-risks.md` #11 for the hang this fixes |
